...
@NgModule({
    ...
    declarations: [
        ...
        IamHomeComponent,
        IamHelpComponent,
        IamProjectListComponent,
        IamMyProjectsComponent,
...
export class AppModule {
    constructor() {
        JoeLogger.action('MODULE', 'NgApp');
        JoeLogger.header(window.location.origin + window.location.pathname);
        JoeLogger.headedInfo('spare Url', localStorage.getItem('app.spareUrl') || '');
    }
}
